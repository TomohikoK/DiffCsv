...
public class DiffCsvTest {
	static private Logger logger = LoggerFactory.getLogger(DiffCsvTest.class);
	...
	public void testMainCase1() {
		String[] params = { //
				"-e", "src/test/resources/com/hoge/btsc_yuko_kwh_l_ext/exp/", // -e
				"-r", "src/test/resources/com/hoge/btsc_yuko_kwh_l_ext/res", // -r
				"-b", "btse001dp", // -b
				"-d", "BTSC_YUKO_KWH_L_EXT", // -d
				"-targetCol", "108", // -targetCol
				"-targetValue", "HYO", // -targetValue
				"-l", "true", // -l
				"-s", "true", // -s
		};
		try {
	...
	public void testMainCase2() throws Exception {
		String[] params = { //
				"-e", "src/test/resources/com/hoge/btsc_yuko_kwh_l_ext/exp/BTSC_YUKO_KWH_L_EXT.csv", // -e
				"-r", "src/test/resources/com/hoge/btsc_yuko_kwh_l_ext/res", // -r
				"-b", "btse001dp", // -b
				"-d", "BTS_YUKO_KWH_L_EXT", // -d
		};
		DiffCsv.main(params);
	}
